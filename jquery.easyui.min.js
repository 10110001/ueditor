...
var pp=$("<div id=\"panel02\" class=\"tabs-panels\"></div>").insertBefore(cc);
cc.children("div").each(function(){
...
if(dir=="east"){
_393="w";
totalH = document.documentElement.clientHeight-50;//001点击右侧界面的面板之后，防止刷新失去高度
var eastH=document.getElementById("tt").style.height=totalH+"px";//001点击右侧界面的面板之后，防止刷新失去高度
}
if(dir=="west"){
_393="e";
}
